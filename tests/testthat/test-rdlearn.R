...
result_1 <- rdlearn(y = "acces", x = "saber11", c = "cutoff", data = colombia_acces,groupname = "department")
plot.rdlearn(result_1)
sens.rdlearn(result_1, M = c(1,2,4))

true_result_1 <- rdlearn(y = "acces", x = "saber11", c = "cutoff", data = colombia_acces,groupname = "department", M = c(1,2,4))
plot.rdlearn(true_result_1)

result_2 <- rdlearn(y = "acces", x = "saber11", c = "cutoff", groupname = "department", data = colombia_acces, fold = 20, M = c(1,2,4))
result_3 <- rdlearn(y = "acces", x = "saber11", c = "cutoff", groupname = "department", data = colombia_acces, fold = 20, cost = c(0,0.2,0.4))

result_4 <- rdlearn(y = "acces", x = "saber11", c = "cutoff", groupname = "department", data = colombia_acces, fold = 20, M = c(1,2), cost = c(0,0.2))
plot.rdlearn(result_4)

result_5 <- rdlearn(y = "acces", x = "saber11", c = "cutoff", groupname = "department", data = colombia_acces, fold = 20, M = c(1,2), cost = c(0))

sim_result_1 <- rdlearn(y="out",x="run",c="cut", data = simdata_1, fold = 10, M = c(1,2,4))
plot.rdlearn(sim_result_1)
