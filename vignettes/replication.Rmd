...
## Data
For our case study, we download the `acces` dataset and apply the proposed methodology to t*he ACCES (Access with Quality to Higher Education) program*, a national-level subsidized loan initiative in Colombia. To qualify for the ACCES program, students must achieve a high score on *the SABER 11*, the national high school exit exam. Each student is assigned a position score ranging from 1 to 1,000, based on each student’s position in terms of 1,000 quantiles.
